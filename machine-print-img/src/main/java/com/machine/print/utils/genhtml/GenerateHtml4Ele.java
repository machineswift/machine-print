...
public class GenerateHtml4Ele {
	...
	public String processSFMessage(String uuid, PrintMessageVo printMessageVo) {
		try {
			...
			/*------------------------------------------------*/
			if (null == elePrintMessageSFVo.getRemarks()) {
				ElePrintRemarksSF remarks = new ElePrintRemarksSF();
				elePrintMessageSFVo.setRemarks(remarks);
				remarks.setRemarks("");
			} else if (null == elePrintMessageSFVo.getRemarks().getRemarks()) {
				elePrintMessageSFVo.getRemarks().setRemarks("");
			}
			/*------------------------------------------------*/
